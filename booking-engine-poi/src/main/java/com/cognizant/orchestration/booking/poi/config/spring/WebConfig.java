...
import com.cognizant.orchestration.booking.poi.web.handler.ExtendedExceptionHandlerExceptionResolver;
import com.cognizant.orchestration.booking.poi.web.handler.GlobalExceptionHandler;
...
public class WebConfig extends WebMvcConfigurationSupport {
    ...
    public void configureHandlerExceptionResolvers(List<HandlerExceptionResolver> exceptionResolvers) {
        ExtendedExceptionHandlerExceptionResolver resolver = new ExtendedExceptionHandlerExceptionResolver();
        resolver.setExceptionHandler(globalExceptionHandler());
