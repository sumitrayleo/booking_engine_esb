package com.cognizant.orchestration.booking.reservation.web.handler;
...
import com.cognizant.orchestration.booking.reservation.dto.ErrorResponse;
import com.cognizant.orchestration.booking.reservation.dto.OrchestrationError;
import com.cognizant.orchestration.booking.reservation.enumeration.ReturnCodeEnum;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorResponse> handle(final ReservationApplException exception, HttpServletRequest httpServletRequest) {
        HttpHeaders headers = new HttpHeaders();
